...
%However, we want to highlight that lessons learned from traditional router design are all the more important in this new context.
...
%we want to highlight that lessons learned from traditional router design are all the more important in this new context
